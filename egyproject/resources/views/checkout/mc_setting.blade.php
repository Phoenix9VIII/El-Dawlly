...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="mc_name">الاسم:{{$d->mc_name}}</p>
                        <p class="p2" dir="rtl"id="mc_id">رقم البطاقة:{{$d->mc_id}}</p>
                        <p class="p2" dir="rtl"id="mc_address">العنوان:{{$d->mc_address}}</p>
                        <p class="p2" dir="rtl"id="mc_phone">رقم التلفون:{{$d->mc_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_mc','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->mc_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>عقد الزواج</em></h4></td>

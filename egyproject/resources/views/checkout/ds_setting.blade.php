...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="ds_name">الاسم:{{$d->ds_name}}</p>
                        <p class="p2" dir="rtl"id="ds_id">رقم البطاقة:{{$d->ds_id}}</p>
                        <p class="p2" dir="rtl"id="ds_address">العنوان:{{$d->ds_address}}</p>
                        <p class="p2" dir="rtl"id="ds_phone">رقم التلفون:{{$d->ds_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_ds','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->ds_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>شهادة الوفاه</em></h4></td>

...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="dc_name">الاسم:{{$d->dc_name}}</p>
                        <p class="p2" dir="rtl"id="dc_id">رقم البطاقة:{{$d->dc_id}}</p>
                        <p class="p2" dir="rtl"id="dc_address">العنوان:{{$d->dc_address}}</p>
                        <p class="p2" dir="rtl"id="dc_phone">رقم التلفون:{{$d->dc_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_dc','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->dc_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>وثيقة الطلاق</em></h4></td>

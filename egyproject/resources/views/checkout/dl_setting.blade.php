...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="dl_name">الاسم:{{$d->dl_name}}</p>
                        <p class="p2" dir="rtl"id="dl_id">رقم البطاقة:{{$d->dl_id}}</p>
                        <p class="p2" dir="rtl"id="dl_address">العنوان:{{$d->dl_address}}</p>
                        <p class="p2" dir="rtl"id="dl_phone">رقم التلفون:{{$d->dl_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_dl','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->dl_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>رخصة القيادة</em></h4></td>

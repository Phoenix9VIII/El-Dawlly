...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="p_name">الاسم:{{$d->p_name}}</p>
                        <p class="p2" dir="rtl"id="p_id">رقم البطاقة:{{$d->p_id}}</p>
                        <p class="p2" dir="rtl"id="p_address">العنوان:{{$d->p_address}}</p>
                        <p class="p2" dir="rtl"id="p_phone">رقم التلفون:{{$d->p_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_p','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->p_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>جواز السفر</em></h4></td>

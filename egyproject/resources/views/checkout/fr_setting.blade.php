...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="fr_name">الاسم:{{$d->fr_name}}</p>
                        <p class="p2" dir="rtl"id="fr_id">رقم البطاقة:{{$d->fr_id}}</p>
                        <p class="p2" dir="rtl"id="fr_address">العنوان:{{$d->fr_address}}</p>
                        <p class="p2" dir="rtl"id="fr_phone">رقم التلفون:{{$d->fr_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_fr','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->fr_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em> القيد العائلي</em></h4></td>

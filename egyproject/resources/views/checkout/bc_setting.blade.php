...
<div class="container">
    <div class="row">
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    ...
                    <address>
                        <p class="p2" dir="rtl"id="bc_name">الاسم:{{$d->bc_name}}</p>
                        <p class="p2" dir="rtl"id="bc_id">رقم البطاقة:{{$d->bc_id}}</p>
                        <p class="p2" dir="rtl"id="bc_address">العنوان:{{$d->bc_address}}</p>
                        <p class="p2" dir="rtl"id="bc_phone">رقم التلفون:{{$d->bc_phone}}</p>
                        </p>
                        {!! Form::open(['url' => 'del_bc','files'=>true]) !!}
                        <input type="hidden" name="t_delete_id" value="{{$d->bc_id}}">
            ...
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-9"><em>شهادة ميلاد</em></h4></td>
